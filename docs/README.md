...
- [`compatibility.md`](compatibility.md) — which mods and modpacks run, the NeoForge base version and what it blocks, and known mod-loading errors with their causes.
